...
<html lang="en">
<head>
    <link rel="stylesheet" href="../asset/admin/adminProfile.css">
    <title>View Profile</title>
</head>
<body>
    <div class="container">
        <header>
            <a class="menu-link" href="adminMenu.php">Home</a>
                ...
                <table class="profile-info" width="100%">
                    <tr>
                        ...
                        <td rowspan="7" class="profile-image">
                            ...
                            <hr>
                            <a class="edit-link" href="uploadadminpp.php">Edit Profile Picture</a>
                        </td>
                    </tr>
                    <tr>
                        <td>Name:</td>
